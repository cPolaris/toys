...
//        frame.addKeyListener(std);    // JLabel cannot get keyboard focus
        ...
        frame.setTitle("Standard Draw Mod.");
    ...
    *************************************************************************/
     ...
     * Draw OFFSCREEN a filled square of side length 2r, centered on (x, y).
     * But the square does not appear ONSCREEN until next call on draw().
     * @param x the x-coordinate of the center of the square
     * @param y the y-coordinate of the center of the square
     * @param r radius is half the length of any side of the square
     * @param dontDraw set to whatever to call this overloaded method
     * @throws IllegalArgumentException if r is negative
     */
    public static void filledSquare(double x, double y, double r, boolean dontDraw) {
        if (r < 0) throw new IllegalArgumentException("square side length must be nonnegative");
        double xs = scaleX(x);
        double ys = scaleY(y);
        double ws = factorX(2*r);
    ...
    *************************************************************************/
    ...
    public static void show(boolean fast) {
        defer = false;
        draw();
        defer = true;
    }
